    ...
    try {
      ...
      if (kind === 'fm' && previousPath && !renamed) {
        ...
        if (existing instanceof TFile) {
          ...
          await this.app.fileManager.processFrontMatter(existing, (fm: Record<string, unknown>) => {
            ...
            const next = buildTaskFrontmatter(task, project, parentTask, this.taskNotesConfig())
      ...
      if (existing instanceof TFile) {
        ...
        await this.app.vault.process(existing, (content) => {
          ...
          return serializeTask(task, project, parentTask, this.statusesFor(project), this.taskNotesConfig())
        })
      } else {
        ...
        const content = serializeTask(task, project, parentTask, this.statusesFor(project), this.taskNotesConfig())
        this.markSelfWrite(filePath)
