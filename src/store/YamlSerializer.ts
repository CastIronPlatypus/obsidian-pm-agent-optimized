...
import { stampTaskNotesMarker, type TaskNotesConfig } from '../integrations/tasknotes'
...
export function buildTaskFrontmatter(
  ...
  // Dual identifier: make the file visible to TaskNotes too. Idempotent and
  // applied last, so it sits over whatever tag/property already round-tripped.
  if (taskNotes) stampTaskNotesMarker(fm, taskNotes)
  return fm
}
