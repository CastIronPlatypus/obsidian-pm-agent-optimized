...
export function collectForeign(
  ...
  for (const [key, value] of Object.entries(r)) {
    ...
    const owned =
      key === 'recurrence' ? isOwnRecurrence(value) : key === 'timeEstimate' ? pmAuthored : TASK_OWNED_KEYS.has(key)
    if (owned) continue
...
export function mapRawToTask(
  ...
  return makeTask({
    ...
    recurrence: isOwnRecurrence(r.recurrence)
      ...
      : undefined,
    timeEstimate: pmAuthored && typeof r.timeEstimate === 'number' ? r.timeEstimate : undefined,
