...
export function mapRawToTask(r: Record<string, unknown>, overrides?: Partial<Task>): Task {
  return makeTask({
    ...foldBlockedBy(r, collectForeign(r), Array.isArray(r.dependencies) ? [...(r.dependencies as string[])] : []),
    id: r.id as string,
